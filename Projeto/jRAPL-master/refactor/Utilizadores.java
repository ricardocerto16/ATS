...
{
    /** Variáveis de instância; String = email: Identificador do utilizador */
    ...
    public void adiciona(Ator a) throws EmailAlreadyInUseException{
        if(this.atores.containsKey(a.getMail())) {
			throw new EmailAlreadyInUseException("Já existe um utilizador com esse e-mail.");
		} else {
			this.atores.put(a.getMail(),a.clone());
		}
    }
    ...
    public void adiciona(String mail, String nome, String pw, String morada, String dDN) throws EmailAlreadyInUseException{
        if(this.atores.containsKey(mail)) {
			throw new EmailAlreadyInUseException("Já existe um utilizador com esse e-mail.");
		} else {
			this.atores.put(mail, new Cliente(mail,nome,pw,morada,dDN));
		}
    }
    ...
    public void adiciona(String mail, String nome, String pw, String morada, String dDN, Veiculo taxi) throws EmailAlreadyInUseException{
        if(this.atores.containsKey(mail)) {
			...
			this.atores.put(mail, new Motorista(mail,nome,pw,morada,dDN,taxi));
		}
    }
    ...
    public boolean equals(Object o){
        ...
        if(this.atores.size() != u.getUtilizadores().size() || hashCode() != u.hashCode()) {
			return false;
		}
