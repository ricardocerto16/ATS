...
public abstract class Ator implements Comparable<Ator>, Serializable
{
    ...
    public boolean equals(Object o){
        ...
        return this.historico.size() == at.getHistorico().size() && hashCode() == at.hashCode() && this.email.equals(at.getMail()) && this.nome.equals(at.getNome()) && this.pw.equals(at.getPassword()) && this.morada.equals(at.getMorada()) 
    ...
    public int compareTo(Ator a){
        ...
        if(r == 0) {
			r = this.nome.compareTo(a.getNome());
		}
        if(r == 0) {
			r = this.pw.compareTo(a.getPassword());
		}
        if(r == 0) {
			r = this.morada.compareTo(a.getMorada());
		}
        if(r == 0) {
			r = this.dataDeNascimento.compareTo(a.getDataDeNascimento());
		}
        if(r == 0){
