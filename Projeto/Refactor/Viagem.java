...
public class Viagem implements Comparable<Viagem>, Serializable
{
   ...
   public boolean equals(Object o) {
    ...
    public String toString(){
        ...
        s.append("\nData da viagem: ").append(this.data.get(GregorianCalendar.DAY_OF_MONTH)).append("-").append(this.data.get(GregorianCalendar.MONTH))
				.append("-").append(this.data.get(GregorianCalendar.YEAR));
